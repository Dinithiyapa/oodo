...
class Crawler(HttpCaseWithUserDemo):
    ...
    def test_05_test_clean_url(self):
        urls_to_check = [
            ...
            ("/controllers?tags=%5B%5D&from=/a/b/c", "/controllers?from=<param>&tags=<param>"),
            ("/controllers?tags=%5B%5D&from=d/e/f&to=/a/b", "/controllers?from=<param>&tags=<param>&to=<param>"),
            ("/controllers?tags=%5B%5D&from=d/e/f&to=/c/d", "/controllers?from=<param>&tags=<param>&to=<param>"),
        ]
        uniq = set()

...
############################################################################
{
    ...
    'assets': {
        'web.assets_frontend': [
            'custom_addons/odoo_website_helpdesk/static/src/js/ticket_details.js',
            'custom_addons/odoo_website_helpdesk/static/src/js/portal_search.js',
            'custom_addons/odoo_website_helpdesk/static/src/js/multiple_product_choose.js',
        ]
    },
